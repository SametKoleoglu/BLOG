...
function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    const notification_res = await apiInstance.get(
      `author/dashboard/notification-list/${user_id}/`
    );
    setNotification(notification_res?.data);
  };
                          ...
                          <div className="d-flex justify-content-between position-relative">
                            <div className="d-sm-flex">
                              ...
                              <div className="ms-0 ms-sm-3 mt-2 mt-sm-0">
                                ...
                                <p className="stretched-link text-decoration-none text-dark fw-bold"></p>
